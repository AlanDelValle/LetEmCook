...
@section('content')
    <div class="flex-col max-w-7xl mx-auto py-6">        
        <div class="flex items-center justify-center space-x-5 mt-20 mb-3">
            <form action="{{ route('cooks.index') }}" method="GET" class="form relative">
        ...
        @if ($cooks->isEmpty())
            <p class="text-center text-gray-400">Nenhum chef encontrado.</p>
        @else
...
<div class="mt-6 text-center">
    {{ $cooks->links('layouts.pagination') }}
</div>
@endsection